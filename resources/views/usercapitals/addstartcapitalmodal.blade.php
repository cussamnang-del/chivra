    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-info kh16-b" id="btnsavecapital">Save</button>
                <button type="button" id="btnclosemodal" class="btn btn-danger kh16-b" data-bs-dismiss="modal">Close</button>
            </div>
        </div>
    </div>
</div>
