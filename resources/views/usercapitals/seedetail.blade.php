@extends('master')
@section('title') ពិនិត្យបិទបញ្ជីបុគ្គលិក @endsection
@section('css')
    <style type="text/css">
        body.wait *{
...
@section('content')
@php
    function phpformatnumber_old($num){
        $dc=0;
        $p=strpos((float)$num,'.');
        if($p>0){
...
<script type="text/javascript">
    $('#h1_title').text('ពិនិត្យបិទបញ្ជីបុគ្គលិកតាមរូបិយប័ណ្ណ');
    tablefixhead(175);
