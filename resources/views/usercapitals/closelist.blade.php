...
@section('css')
    ...
    .tableFixHead thead th { position: sticky; top: 0; z-index: 1;background-color:rgb(152, 173, 173) }
    .tbl_userreport td{
        padding:2px;
    }
    .tbl_userreport th{
    ...
    .checkbox-large {
        transform: scale(1.5);   /* 1.0 = normal, 1.5 = bigger */
        ...
        <div class="table-responsive">
            <table class="">
                ...
                <tr>
                    ...
                    <td style="border-style:none;padding:0px;">
                        <button id="btnshow" class="mybtn kh16" style="margin-left:20px;background-color:green;color:white;width:80px;">បង្ហាញ</button>
                    </td>
                    <td style="border-style:none;padding-right:5px;">
                        <button id="btnprint" class="mybtn kh16" style="width:50px;background-color:green;color:white;">ព្រីន</button>
                    </td>
                    <td style="border-style:none;text-align:right;" class="kh14-b">
                        <button id="btnendbalance" class="mybtn kh16" style="background-color:rgb(114, 11, 117);color:white;width:80px;">ដកចុងគ្រា</button>
                    </td>
                    <td style="border-style:none;padding:0px;">
                        <button id="btnprintend" class="mybtn kh16" style="background-color:rgb(114, 11, 117);color:white;width:50px;">ព្រីន</button>
                    </td>
                    <td style="border-style:none;padding-right:5px;text-align:right;" class="kh14-b">
                        <button id="btndelendbalance" style="background-color:red;color:white;" class="mybtn kh16">លុបដកចុងគ្រា</button>
                    </td>
                    <td style="border-style:none;padding:0px;text-align:right;" class="kh14-b">
                        <button id="btncontinue" class="mybtn kh16" style="background-color:darkorange;color:white;">បន្តថ្ងៃស្អែក</button>
                    </td>
                    <td style="border-style:none;padding:0px;text-align:right;" class="kh16-b">
                        <button id="btncontinueall" class="mybtn kh16" style="background-color:darkorange;color:white;">បន្តថ្ងៃស្អែកទាំងអស់</button>
                    </td>
                </tr>
            </table>
        </div>
                        ...
                        if($.isEmptyObject(data.error)){
                            ...
                            for (let i = 0; i < data['endbals'].length; i++) {
                                ...
                                for (let j = 0; j < data['currencies'].length; j++) {
                                    ...
                                    output += `
                                        <td>
                                            <input type="text" class="kh16-b" value="${formatNumber(value) + ' ' + cur1}" readonly style="width:100%;text-align:right;">
                                        </td>
                                    `;
                                }
