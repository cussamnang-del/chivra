                                ...
                                <div class="table-responsive">
                                    <table id="tbl_offer_modal" class="table kh22">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control kh22-b" name="amount1" id="amount1" style="text-align:right;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" id="amount2" name="amount2" class="form-control kh22-b" style="text-align:right;" readonly>
                                            </td>
                                            <td>
