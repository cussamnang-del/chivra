...
@endphp
        ...
        @if($r->currency->ismain==1)
            ...
            <tr class="kh16-b">
                <td style="text-align:center;">{{ ++$key }} <br>
                    <a href="{{ route('usercapital.seedetail',[$r->currency_id,$r->currency->curname??'',$r->currency->shortcut??'',$r->currency->isexchangecur??0,$r->currency->ismain??0,$r->viewdate,$r->user_id,$r->user->name,$fromdate,$ckcash,1,1,0]) }}" class="mybtn kh12-b" style="" target="_Blank">View</a>
                </td>
                <td style="text-align:center;display:none;">
                    <input type="text" style="border-style:none;width:60px;background-color:transparent" name="curid[]" value="{{ $r->currency_id }}">
                </td>
                <td style="text-align:center;">{{ $r->currency->curname }} <br> {{ $r->currency->shortcut }}</td>
        ...
        @else
         ...
         <tr class="kh16-b">
             <td style="text-align:center;">{{ ++$key }} <br>
                <a href="{{ route('usercapital.seedetail',[$r->currency_id,$r->currency->curname??'',$r->currency->shortcut??'',$r->currency->isexchangecur??0,$r->currency->ismain??0,$r->viewdate,$r->user_id,$r->user->name,$fromdate,$ckcash,1,1,0]) }}" class="mybtn kh12-b" style="margin-top:8px;" target="_Blank">View</a>
             </td>
             <td style="text-align:center;display:none;">
                 <input type="text" style="border-style:none;width:60px;background-color:transparent" name="curid[]" value="{{ $r->currency_id }}">
             </td>
