    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <table class="">
                    <tr>
                        <td class="tdcontinue" style="border-style:none;">
                            <table>
                                <tr>
                                    <td style="border-style:none;">
                                        <div class="form-check">
                                            <input class="form-check-input checkbox-large" type="checkbox" name="ckcontinue" id="ckcontinue" checked>
                                            <label class="form-check-label kh16-b" for="ckcontinue">
                                                បន្តថ្ងៃស្អែក
                                            </label>
                                        </div>
                                    ...
                                    <td style="border-style:none;padding-left:20px;">
                        ...
                        <td style="border-style:none;width:100px;padding-left:20px;">
