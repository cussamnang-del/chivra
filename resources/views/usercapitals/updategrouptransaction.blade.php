    ...
    <form id="frmtransfer" action="">
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <div class="card" style="@if($justeditinfo==1) pointer-events: none; opacity: 0.3; @endif">
                        ...
                        <div class="table-responsive">
                            <table id="tbl_amount" class="table kh16-b">
                                ...
                                <tr id="row_totalcash" style="@if($transfer->trancode<0) display:none; @endif">
                                    ...
                                    <td style="width:80px;">
                                        <input type="text" class="form-control kh16-b" id="txtcur" style="width:80px;padding:0px 3px;height:30px;" value="{{ $transfer->currency->shortcut }}" readonly>
                                    </td>
                                </tr>
                                      ...
                                      <tr>
                                          ...
                                          <td colspan=2>
                                              <select class="form-select select2-option kh16-b" name="selpartner2" id="selpartner2" style="width:100%">
                                                <option value=""></option>
                                                @foreach ($partners as $p)
                                                    <option value="{{ $p->id }}" customertype="{{ $p->customertype }}" userconnect="{{ $p->user_connect }}" thai_list="{{ $p->thai_list }}" countrycode="{{ $p->tel }}" agenttype="{{ $p->agent_type_id }}" maxtransfer="{{ $p->agenttype->transfer_amount }}" maxcuscharge="{{ $p->agenttype->customer_fee }}" maxfee="{{ $p->agenttype->cashdraw_fee }}" maxtransferfee="{{ $p->agenttype->transfer_fee }}" @if($transfer1 && $transfer1->count()>0) {{ $transfer1->parrent_id==$p->id?'selected':'' }} @endif>{{ $p->name }}</option>
                                                @endforeach
                                              </select>
                                          </td>
                                      </tr>
            ...
            <div class="row" style="">
                ...
                <div class="col-lg-4">
                    <div style="float:right;margin-top:8px;">
                        ...
                        @else
                            <button id="btnsavetransfer_info" class="btn btn-warning kh16-b" style="">UPDATE Info</button>
                            <button id="btnsavetransferprint_info" class="btn btn-warning kh16-b" style="margin-right:10px;">UPDATE Info PRINT</button>
                        @endif
                    </div>
                </div>
            </div>
