                    ...
                    <table class="table table-bordered kh16-b">
                        ...
                        <tbody>
                            ...
                            <tr class="kh16" style="text-align:center;">
                                ...
                                <td>
                                    {{ date('d-m-Y',strtotime($item->smsdate))  . ' ' . $item->smstime }}
                                </td>
                                <td>{{ phpformatnumber($item->amount) . ' ' . $item->cur }}</td>
                                <td>{{ $item->smstext }}</td>
                                <td>{{ $item->smsnote }}</td>
                ...
                <tr>
                    ...
                    <table class="table table-bordered kh16-b">
                        ...
                        <tbody>
                            ...
                            <tr class="kh16" style="text-align:center;@if($item->amount>0) color:blue; @else color:red; @endif">
                                <td>{{ sprintf("%04d",$item->id) }}</td>
                                <td>{{ $item->user->name }}</td>
                                <td>{{ date('d-m-Y',strtotime($item->trandate))  . ' ' . $item->trantime }}</td>
                                <td>{{ $item->useraffect->name }}</td>
                                <td>{{ $item->tranname }}</td>
                                <td>{{ phpformatnumber($item->amount) . ' ' . $item->currency->shortcut }}</td>
...
@section('script')
    ...
    <script type="text/javascript">
        $('#h1_title').text('ក្រុមប្រតិបត្តិការណ៏');
