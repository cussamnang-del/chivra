   ...
   <div class="">
        <table>
            <tr>
                ...
                <td>
                    <select id="seluser" multiple name="seluser" class="select" style="" placeholder="Select User" data-search="false" data-silent-initial-value-set="true">
                        @foreach ($users as $u)
            ...
            <div class="tableFixHead">
                ...
                <table id="tbl_list" class="table tbl_list kh14" style="table-layout:fixed;">
                    <thead style="text-align:center;">
                        ...
                        <th id="col_desr" style="">បរិយាយ</th>
