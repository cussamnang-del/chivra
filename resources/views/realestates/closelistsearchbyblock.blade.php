                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    @else
                                        ...
                                        <li><a class="dropdown-item kh16-b btnpayment" style="" href="#" data-id="{{ $tr->main_id }}"><i class="fa fa-money"></i> កក់ប្រាក់បន្ថែម</a></li>
                                        <li>
                                            <a class="dropdown-item kh16-b" href="{{ route('realestate.viewallcustomertransaction',['id'=>$tr->main_id,'customer_id'=>$tr->main_parrent_id,'customertype'=>$tr->main_customertype,'buyer'=>$tr->buyer,'term'=>$tr->main_term,'rate'=>$tr->main_interest_rate,'startdate'=>$tr->main_startdate,'enddate'=>$tr->main_enddate,'curid'=>$tr->currency_id,'cursk'=>$tr->sk,'curname'=>$tr->shortcut,'payinmonth'=>$tr->main_payinmonth,'ispayromlos'=>1,'sendername'=>$tr->main_property]) }}" target="_blank"><i class="fa fa-eye"></i> មើលប្រតិបត្តិការណ៏ទាំំងអស់</a>
                                        </li>
                                    @endif
