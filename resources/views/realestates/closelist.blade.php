    ...
    <div class="row" style="margin-top:-10px;">
        <table class="" style="margin:0px;padding:0px;">
            <tr>
                ...
                <td class="kh16-b" style="padding:0px 5px 0px 10px;border-style:none;">
                     <select name="selproperty" id="selproperty" class="form-select" style="width:150px;">
                ...
                <td style="padding:0px;border-style:none;">
                    ...
                    <button class="mybtn kh16-b" onclick="printSelectedColumns()">Preview</button>
                     <button id="btnsortproperty" class="mybtn kh16-b">Sort A->Z</button>
                </td>
...
//console.log(labels); // ["Group A", "Group B"]
        ...
        function getsearch()
        {
          ...
          $(document).on('click', '#btnsortproperty', function (e) {
            ...
            rows.sort((rowA, rowB) => {
                const valA = $(rowA).find('td').eq(3).text().trim(); // ✅ adjust column index if needed
                const valB = $(rowB).find('td').eq(3).text().trim();
