<script type="text/javascript">
    ...
    function getsolelist()
    {
        ...
        @endif
        var loancomplete = document.getElementById("loancomplete").checked;
        ...
        $.ajax({
            ...
            type: 'GET',
            url: url,
            data: {trancode:trancode,paymenttype:paymenttype,selgroup:selgroup,property_id:property_id,loancomplete:loancomplete},
    ...
    $(document).on('change','input[name="optlist"]',function(e){
     ...
     $(document).on('click','.btnselbal',function(e){
        e.preventDefault()
        var v=$(this).data('v')
        searchmytable(v);
    ...
    //     });
    // });
   function searchmytable(input) {
   // debugger;
   var tbody = document.getElementById("body_transaction");
