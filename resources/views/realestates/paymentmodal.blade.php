                                ...
                                <div class="table-responsive" style="margin:10px 0px 0px 10px;">
                                    <table id="tbl_partner" class="table" style="table-layout:fixed;">
                                        ...
                                        <tr id="row_deposit" style="">
                                         ...
                                         <tr id="row_deposit" style="">
                                            <td class="kh16-b">បញ្ចុះតំលៃ</td>
                                            <td colspan=2>
                                                <div class="input-group">
                                                    <input type="text" class="form-control kh22-b" id="bonus" name="bonus" style="text-align:right;height:30px;color:red;" value="0">
                                                    <input type="text" name="bonuscur" class="input-group kh22-b cur" style="width:80px;height:30px;border:1px solid gray;color:red;" readonly>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr id="row_cuscharge_debt" style="">
                                            ...
                                            <td colspan=2>
                                                <div class="input-group">
                                                    <input type="text" class="form-control kh16-b" id="old_cuscharge_debt" name="old_cuscharge_debt" value="0" style="text-align:right;height:30px;">
                                                    <input type="text" class="input-group kh16-b" value="USD" style="width:80px;height:30px;border:1px solid gray" readonly>
                                                </div>
                                            </td>
                                        </tr>
