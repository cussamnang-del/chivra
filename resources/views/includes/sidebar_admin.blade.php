...
<style>
    ...
    /* submenu items only */
    #menu > li > ul > li > a {
        font-size: 17px;   /* change to what you want */
        font-family: 'khmer os system', sans-serif;
        font-weight: 300;
    }

   /* ONLY submenu items under the main menu */
    #menu > li > ul > li > a {
...
<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <!--navigation-->
        <ul class="metismenu" id="menu" style="">
                ...
                <ul>
                    ...
                    <li title="code:3.1">
                        ...
                        <a
                            ...
                            @if(config('helper.exchange_auto_capture')==1 && Auth::user()->use_camra==1) onclick="window.open('{{ route('exchange.recognit') }}', 'recognitWindow');" @endif
                            style="">1. ប្តូរប្រាក់
                        </a>
                    ...
                    <li title="code:3.3">
                        <a href="{{ route('currency.exchangeratenew') }}" style="font-weight:bold;" class="">2. កំណត់អត្រាប្តូរប្រាក់</a>
                    </li>
                    <li title="code:3.2"> <a href="{{ route('exchangelists') }}" style="">3. របាយការណ៏ប្តូរប្រាក់</a>
                    </li>
                    <li title="code:3.2"> <a href="{{ route('exchangelistsnew') }}" style="">4. របាយការណ៏ទិញលក់</a>
                    </li>
                    @if(config('helper.haveexchangegold')==1)
                        <li title="code:3.2"> <a href="{{ route('exchangegoldreport') }}" style="">5. របាយការណ៏កក់មាស</a>
                        </li>
                         <li title="code:3.2"> <a href="{{ route('exchangegoldlist') }}" style="">* បញ្ជីមាស</a>
                        </li>
                    @endif
                    ...
                    <li title="code:3.6">
                        <a href="{{ route('currency.ratedisplayforcustomer',[0,0]) }}" style="" class="" target="_blank">8. បង្ហោះអត្រាប្តូរប្រាក់</a>
                    </li>
                    <li title="code:3.6">
                        <a href="{{ route('currency.ratedisplayforcustomer',[1,0]) }}" style="" class="" target="_blank">8. បង្ហោះអត្រាបរទេស</a>
                    </li>
                    @if(config('helper.haveexchangegold')==1)
                        <li title="code:3.6">
                            <a href="{{ route('currency.goldrate') }}" style="" class="" target="_blank">9. បង្ហោះអត្រាមាស</a>
                        </li>
                    @endif
                    <li title="code:3.7">
                        <a href="{{ route('currency.ratedisplaytv') }}" style="" class="" target="_blank">10. ប៉ុស្តិ៍អត្រាប្តូរប្រាក់</a>
                    </li>
                    @if(config('helper.exchange_auto_capture')==1)
                        <li title="code:3.8"> <a href="{{ route('customerexchangelist') }}" style="">11. រូបអតិថិជនប្តូរប្រាក់</a>
                        </li>
                        <li title="code:3.9"> <a href="{{ route('pagetime') }}" style="">12. ថេរវេលាប្តូរប្រាក់</a>
                        </li>
                    @endif
                </ul>
            </li>
            <li>
                <a title="code:3" href="javascript:;" class="has-arrow" style="">
                    <div class="parent-icon"><i class='fa fa-server'></i>
                    </div>
                    <div class="menu-title" style="">ទិញលក់មាស</div>
                </a>
                <ul>
                    <li title="code:3.3">
                        <a href="{{ route('exchangegoldapp.setgoldrate') }}" style="" class="">1. កំណត់ហាងឆេងមាស</a>
                    </li>
                    <li title="code:3.3">
                        <a href="{{ route('exchangegoldapp.buysalegold') }}" style="" class="">2. ទិញលក់មាស</a>
                    </li>
                    <li title="code:4.4"> <a href="{{ route('moneytransfer.customertransfer1') }}" style="">4. ដាក់ដកប្រាក់</a>
                    </li>
                    <li title="code:3.3">
                        <a href="{{ route('exchangegoldapp.report') }}" style="" class="">2. របាយការណ៏ទិញលក់</a>
                    </li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li title="code:11.7"> <a href="{{ route('thaicashdraw.cashdrawreport') }}" >7. របាយការណ៏បើកវេរថៃ</a>
                    </li>
                    <li title="code:11.8"> <a href="{{ route('thaicashdraw.notyetcashdrawreport') }}" >8. របាយការណ៏ស្តុកថៃ</a>
                    </li>
                     <li title="code:11.9"> <a href="{{ route('thaicashdraw.registerthaicustomer') }}" >9. ចុះឈ្មោះអតិថិជនថៃ</a>
                    </li>
                </ul>
            </li>
            <li>
            ...
            <li>
                ...
                <ul>
                    <li title="code:4.7"><a href="{{ route('moneytransfer.indexreport') }}" style="font-weight:600;" class="">* របាយការណ៏ផ្ទេរប្រាក់</a></li>
                    <li title="code:8.2"> <a href="{{ route('moneytransfer.cashdrawreportreport') }}" style="font-weight:600;">* របាយការណ៏បើកវេរ</a></li>
                    <li title="code:4.9"><a href="{{ route('moneytransfer.update_delete_report_report') }}" style="font-weight:600;" class="">* របាយការណ៏កែលុប</a></li>
                    <li title="code:3.2"> <a href="{{ route('exchangelistsreport') }}" style="font-weight:600;">* របាយការណ៏ប្តូរប្រាក់</a></li>
                    <li title="code:6.1">
                        <a href="{{ route('closelist.index') }}" style="" class="">1. បិទបញ្ជីរួមប្រចាំថ្ងៃ</a>
                    </li>
                    <li title="code:6.2">
