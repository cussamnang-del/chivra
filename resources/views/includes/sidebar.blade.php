        ...
        <ul class="metismenu" id="menu" style="">
            ...
            <li id="code11" style="display:none;">
                ...
                <ul>
                    ...
                    <li id="code11_4" style="display:none;"> <a href="{{ route('thaicashdraw.accountregister') }}" style="">4. ចុះលេខបញ្ជី</a>
                    </li>
                    <li id="code11_5" style="display:none;"> <a href="{{ route('thaicashdraw.accountlistreport') }}" style="">5. របាយការណ៏លេខបញ្ជី</a>
                    </li>
                    <li id="code11_6" style="display:none;"> <a href="{{ route('thaicashdraw.closelist') }}" style="">6. កំណត់ទឹកប្រាក់បញ្ជី</a>
                    </li>
                    <li id="code11_7" style="display:none;"> <a href="{{ route('thaicashdraw.cashdrawreport') }}" >7. របាយការណ៏បើកវេរថៃ</a>
                    </li>
                    <li id="code11_8" style="display:none;"> <a href="{{ route('thaicashdraw.notyetcashdrawreport') }}" >8. របាយការណ៏ស្តុកថៃ</a>
                    </li>
                     <li id="code11_9" style="display:none;"> <a href="{{ route('thaicashdraw.registerthaicustomer') }}" >9. ចុះឈ្មោះអតិថិជនថៃ</a>
                    </li>
                </ul>
            </li>
