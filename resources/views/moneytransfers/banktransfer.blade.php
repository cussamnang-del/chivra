                          ...
                          <table id="tbl_amount" class="table kh18" style="table-layout:fixed;margin-top:10px;">
                                ...
                                <tr>
                                    ...
                                    <td colspan=2>
                                        ...
                                        <select name="selcur" id="selcur" class="input-group kh22-b" style="width:80px;padding-top:4px;">
                                            <option value=""></option>
                                ...
                                <tr>
                                    ...
                                    <td colspan=2>
                                        <div class="input-group">
                                            ...
                                            <select name="selcur2" id="selcur2" class="input-group kh22-b" style="width:80px;padding-top:4px;">
                                                <option value=""></option>
                                                @foreach ($currencies as $c)
                                                    <option value="{{ $c->id }}">{{ $c->shortcut }}</option>
                                                @endforeach
