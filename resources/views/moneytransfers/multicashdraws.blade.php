                  ...
                  @foreach ($multicashdraws as $key => $mtr)
                    <tr>
                      ...
                      <td class="kh16-b" style="text-align:right;padding:0px;">
                        <input type="text" class="form-control kh16-b list_cuscharge tdcanenter2" style="text-align:right;width:120px;height:40px;" name="list_cuscharge[]" value="{{ phpformatnumber($mtr->cuscharge) }}" >
                      </td>
                      <td class="kh16-b" style="text-align:right;padding:0px;">
