     ...
     <div class="row" style="margin-bottom:10px;margin-top:-20px;">
                ...
                <table class="" style="padding:0px;margin:0px;">
                    <tr>
                        <td style="border-style:none;padding:0px;">
                            <button id="btnback" class="buttonstyle kh12-b" style="display: none; background-color: aquamarine;padding: 4px; font-size: 12px; line-height: 1;">⇒</button>
                        </td>
        ...
        <div class="col-lg-6">
            <div class="row">
                    ...
                    <table class="" style="padding:0px;margin:0px;">
                        <tr>
                            <td style="border-style:none;width:180px;">
                                <select name="filteruser" id="filteruser" style="height:30px;width:180px;" class="kh14-b">
                            ...
                            <td style="width:70px;">
                                <button class="mybtn kh16-b" style="border:1px dotted black;width:70px;" id="btnrefresh">Show</button>
                            </td>
                            <td style="border-style:none;">
    ...
    <div class="row" style="margin-top:0px;">
        <form id="frmtransfer" action="">
            <div class="row">
                ...
                <div class="col-lg-6" id="myDiv2" style="">
                    ...
                    <div class="row" style=" position: relative;z-index: 1;">
                        <div id="divgettransaction" style="">
                            ...
                            <div class="tableFixHead" id="resizable">
                                {{-- <div class="table-responsive"> --}}
                                    ...
                                    <table id="tbl_transferlist" class="table table-bordered table-hover tbl_transferlist" style="table-layout:fixed;">
                                        <thead style="text-align:center;" class="kh16">
                                            ...
                                            <th style="width:150px;">ក្រុមប្រតិបត្តិការណ៏</th>
            ...
            <div class="tableFixFooter">
                <table class="" style="margin-left:5px;margin:0px;padding:0px;">
                    <tr>
                        ...
                        <td>
                            <button id="btnsavewithcashdraw" class="button1 kh16-b btnsavewithcashdraw" style="width:100px;background-color:bisque;">បើកវេរ</button>
                        </td>
                        <td>
                            <button id="btnsavewithcashdrawprint" class="button1 kh16-b btnsavewithcashdrawprint" style="width:100px;background-color:bisque;">បើកវេរព្រីន</button>
                        </td>
                    </tr>
                </table>
