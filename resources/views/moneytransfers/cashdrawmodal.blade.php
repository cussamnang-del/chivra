                            ...
                            <div class="card">
                                <div class="card-header" style="height:35px;">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <span style="float:right;font-size:12px;font-weight:bold;margin-left:20px;margin-top:-6px;"><button id="btnclosedivbankpayment" class="mybtn" style="color:red;">X</button></span>
                                            <button id="btnaddrow" class="mybtn" style="float:right;margin-top:-6px;">add row</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body" style="padding-bottom:0px;">
