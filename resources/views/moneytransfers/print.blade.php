    ...
    <div id="invoice-pos">
        ...
        <div class="row">
            <table class="" style="">
                ...
                <tr>
                    <td class="kh16-b" style="width:100%;text-align:center;padding:0px;">{{ $logo->subname }}</td>
                </tr>
                <tr>
                    <td class="kh16-b" style="width:100%;text-align:center;padding:0px;">{{ $logo->tel }}</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
            ...
            <table id="tbl_body" class="table" style="">
                <tbody>
                  ...
                  <tr>
                      ...
                      <td class="kh12-b" style="width:5%;">:</td>
                      <td class="kh12-b" style="width:75%;font-size:16px;border:2px dotted black;padding:0px 3px;">{{ trim(chunk_split($transfer->rectel, 3, ' ')) }} @if($transfer->recname) <br> {{ $transfer->recname }} @endif</td>
                  </tr>
                    <tr>
                        <td class="kh12-b" style="width:20%">វេរចំនួន</td>
                        <td class="kh12-b" style="width:5%;">:</td>
                        <td class="kh12-b" style="width:75%;font-size:16px;text-align:right;">{{ phpformatnumber($transfer->amount) . $transfer->currency->sk }}</td>
                    </tr>
                    <tr>
                        <td class="kh12-b" style="width:20%">បូកសេវ៉ា</td>
                        <td class="kh12-b" style="width:5%;">:</td>
                        <td class="kh12-b" style="width:75%;text-align:right;">{{ phpformatnumber($transfer->cuscharge) . $transfer->cuschargecur->sk }}</td>
                    </tr>
                    <tr>
                        <td class="kh12-b" style="width:20%">សរុប</td>
                        <td class="kh12-b" style="width:5%;">:</td>
                        <td class="kh12-b" style="width:75%;font-size:16px;text-align:right;">
