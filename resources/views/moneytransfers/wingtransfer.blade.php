...
@section('content')
    ...
    @endphp
     ...
     <div class="row" style="margin-bottom:10px;margin-top:-20px;">
                    ...
                    <div class="row" style="margin-right:10px;">
                        ...
                        <table id="tbl_partner" class="table table-bordered;" style="table-layout:fixed;">
                            ...
                            <tr>
                                ...
                                <td colspan=2>
                                    <div class="input-group">
                                        <select name="selfee" id="selfee" class="kh16-b">
                                            <option value="-">អោយគេ</option>
                                            <option value="+">អោយយើង</option>
                                        </select>
        ...
        <div id="divdisplay" class="col-lg-6">
            <div class="row">
                <div class="table-responsive">
                    <table>
                      <tr>
                          ...
                          <td colspan=2 style="padding:0px;width:120px;">
                          ...
                          <td style="padding:0px">
                           ...
                           <td style="padding:0px">
                              <label for="date" class="kh16" style="">រូបិយប័ណ្ណ</label>
                          </td>
                      ...
                      <tr>
                        ...
                        <td style="padding:0px">
                            <select name="selcursearch" id="selcursearch" class="input-group kh16-b" style="width:80px;height:30px;">
                                <option value="">ទាំំងអស់</option>
                                @foreach ($currencies as $c)
                                    <option value="{{ $c->id }}">{{ $c->shortcut }}</option>
                                @endforeach
                            </select>
                        ...
                        <td>
                            <button class="button1 kh12-b" id="btnsearch">Search</button>
                        </td>
                        <td>
