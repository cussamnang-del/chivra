<script type="text/javascript">
    ...
    $(document).on('mousemove', function (e) {
        ...
        if (direction === 'right' || direction === 'corner') {
            box.width(startWidth + (e.clientX - startX));
        }

        if (direction === 'bottom' || direction === 'corner') {
            box.height(startHeight + (e.clientY - startY));
        }
    });
    ...
    function tablefixhead(h)
    {
     ...
     $('#btnmoveleft').on('click', function (e) {
        ...
        $('#myDiv1').removeClass('col-lg-6').addClass('d-none');
        $('#myDiv2').removeClass('col-lg-6').addClass('col-lg-12');
        $('#btnback').show().text('⇒');
        $('#btnmoveleft').hide();
    });
    ...
    $('#btnback').on('click', function () {
        if ($('#myDiv1').hasClass('d-none')) {
            ...
            $('#myDiv1').removeClass('d-none').addClass('col-lg-6');
            $('#myDiv2').removeClass('col-lg-12').addClass('col-lg-6');
  ...
  $(document).ready(function () {
    ...
    if(!isAdmin){
      ...
      {
        if (!hasPermission(currentUserId, '4.1.1')) {$('#li_changedate').css('display','none');}
        if (!hasPermission(currentUserId, '4.1.2')) {$('#li_delbyid').css('display','none');}
        if (!hasPermission(currentUserId, '4.1.3')) {$('#li_delbygroup').css('display','none');}
        if (!hasPermission(currentUserId, '4.1.4'))
        {
    ...
    //   });
     ...
     function gettransferlist()
      ...
      $(document).on('click','.btndeltransfer',function(e){
        ...
        if(!isAdmin){
            if (!hasPermission(currentUserId, '4.1.2')) {
