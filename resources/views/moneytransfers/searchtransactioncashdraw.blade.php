              ...
              @foreach ($cashdraws as $key => $d)
                      <tr class="rowclick">
                          ...
                          <td style="text-align:center;">
                              ...
                              @endif
                              <a href="#c{{ $d->id }}" class="mybtn btnviewcashdraw" data-id="{{ $d->id }}" data-bs-toggle="collapse"><i class="fa fa-eye" style="font-size:16px;padding-top:1px;"></i></a>
                          </td>
                          <td>{{ $d->id }}</td>
                          <td>{{ date('d-m-Y',strtotime($d->dd))}}</td>
                      ...
                      @foreach (App\Cashdraw::showcashdraw($d->id) as $item)
                          <tr id="c{{ $d->id }}" class="collapse" style="background-color:rgb(238, 241, 245);">
