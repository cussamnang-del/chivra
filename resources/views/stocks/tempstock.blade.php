...
<tr style="background-color:aqua;">
    <td colspan=5 style="font-size:22px;font-weight:bold;">Total Amount</td>
    <td style="font-size:22px;text-align:right;font-weight:bold;">{{ phpformatnumber($total_usd) }} USD</td>
    <td></td>
</tr>
