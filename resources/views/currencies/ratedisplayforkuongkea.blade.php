                            ...
                            <table class="table" style="margin:0px;background-color:white;">
                                <tr style="background-color:black;">
                                    <td style="width:33.33%;border-style:none;text-align:left;background-color:white">
                                        ...
                                        <span class="three-d-text moul-regular" style="position: relative;top:-70px;left:80px;font-size:36px;font-weight:bold;color:goldenrod"> {{$company->name}}</span>
                                    </td>
                                    <td style="text-align:center;border-style:none;color:rgb(19, 202, 235);background-color:white">
                                        <div class="mainshortcut">

                                            <div class="three-d-text moul-regular" style="font-size:36px;font-weight:bold;position: relative;top:-10px;color:gold;">
                                                អត្រាប្តូរប្រាក់
                                            </div>
                                ...
                                <table class="table table-bordered"  style="width:100%;margin-top:-10px;">
                                 ...
                                 <table class="table" style="margin-top:-10px;">
                                    <tr style="background-color:#094853;">
                                        <td style="font-family:khmer os muol light; font-size:42px;padding-top:10px;padding-left:5px;border-style:none;line-height:1.5">
                                            ទំនាក់ទំនង៖
