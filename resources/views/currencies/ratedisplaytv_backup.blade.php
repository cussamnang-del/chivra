    ...
    <div id="divheader1" class="row">
        <div class="col-lg-6">
            <div class="row">
                ...
                padding:20px;
                overflow:hidden;">
                    <h1 id="companyname" style="font-size:56px;">{{ $company->name }}</h1>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
                    ...
                    <div class="card-body" style="padding:0px;">
                            ...
                            <div class="table-responsive" style="margin-top:-17px;">
                                <table class="table table-bordered table-striped"  style="width:100%;">
                                    ...
                                    <tr style="background-color:rgb(243, 240, 234)">

                                        <td class="thaibank" colspan=3>

                                                <img src="{{ config('helper.asset_path').'/logo' . '/thaibank1.jpg' }}" alt="" style="width:100px;border-radius: 50%;" class="">

                                                ធនាគាថៃ/THAI BANK

                                                <img src="{{ config('helper.asset_path').'/logo' . '/thaibank2.jpg' }}" alt="" style="width:100px;border-radius: 50%;" class="">
                                    ...
                                    <tr>
                                        ...
                                        <td class="bc3 zipbra" style="">
                                            <div class="relativeamt" style="padding-right:20px;">
                                                {{ number_format($c1->buy,$c1->decpoint,'.','') }}
                                            </div>
                                        </td>

                                        <td class="bc4 zipbra" style="">
                                            <div class="relativeamt" style="padding-right:20px;">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped1" style="width:100%;">
                                <tr>
                                    ...
                                    <th class="thd">ទិញចូល</th>
                                    <th class="thd">លក់ចេញ</th>
                                </tr>
                                @foreach ($cur2 as $c2)
                                <tr>
                ...
                <table class="table" style="">
                    <tr>
                        ...
                        <td class="qrfooter" rowspan=2 style="">
                            <div class="qrcode">
                                <img src="{{ config('helper.asset_path').'/logo' . '/chivra2.png' }}" alt="" style="width:100px;" class="">
                            </div>
                            <div class="qrcode">
                                <img src="{{ config('helper.asset_path').'/logo' . '/chivraqr1.jpg' }}" alt="" style="width:100px;" class="">
                            </div>
                            <div class="qrcode">
                                <img src="{{ config('helper.asset_path').'/logo' . '/chivra3.jpg' }}" alt="" style="width:100px;" class="">
                            </div>
                        </td>
