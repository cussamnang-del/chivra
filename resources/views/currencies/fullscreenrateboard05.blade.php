...
<body>
  ...
  <div class="container">
        ...
        <div class="card" style="">
                <table class="table" style="margin:-20px 0px 0px 0px;background-color:#0b972b;">
                    <tr style="background-color:black;">
                        <td style="width:33.33%;border-style:none;text-align:left;background-color:#0b972b">
                            <div class="mainshortcut">
                                <div class="imgflag">
                                    <div class="circular--logo2">
                                        <img style="width:20%;margin-left:15px;margin-top:30px;" src="{{ config('helper.asset_path'). '/logo/' . $company->logo  }}" />
                                    </div>
                                </div>
                            <span class="three-d-text" style="position: relative;top:-110px;left:130px;font-family:khmer os muol light;font-size:62px;font-weight:bold;color:goldenrod"> {{$company->name}}</span>
                        </td>
                        <td style="text-align:center;border-style:none;color:rgb(19, 202, 235);background-color:#0b972b">
                            <div class="mainshortcut">

                                <div class="three-d-text" style="font-family:khmer os muol light;font-size:48px;font-weight:bold;position: relative;top:-10px;color:gold;">
                                    អត្រាប្តូរប្រាក់
                                </div>
                                <div class="three-d-text" style="font-family:Arial, Helvetica, sans-serif;font-size:42px;font-weight:bold;position: relative;top:-10px;color:gold;">
                                    Exchange Rate
                                </div>
                            </div>

                        </td>
                        <td style="width:33.33%;border-style:none;font-family:Arial, Helvetica, sans-serif;font-size:36px;font-weight:bold;text-align:right;padding-right:20px;background-color:#0b972b">

                            <div class="mainshortcut">
                                <div class="three-d-text" style="font-family:Arial, Helvetica, sans-serif;font-size:36px;font-weight:bold;margin-top:0px;position: relative;top:0px;color:rgb(163, 163, 212)">
                                   <span style="font-size:50px;">{{ date('d-m-Y',strtotime($maxdate)) }}</span>
                                   {{-- <span>{{ date('H:i:s',strtotime($maxdate)) }}</span> --}}
                                </div>
                                <div class="three-d-text" style="font-family:Arial, Helvetica, sans-serif;font-size:36px;font-weight:bold;margin-top:0px;position: relative;top:0px;color:rgb(182, 182, 224);">
                        ...
                        <tbody>
                            ...
                            @foreach ($cur1 as $c1)
                                ...
                                <tr class="{{$cbk}}">
                                    ...
                                    @if($c1->ispandp==1)
                                        <td class="bc4 three-d-text digital" style="color:blue;text-align:center;padding:0px;">
                                            <div class="relativeamt" style="">
                                                {{ number_format($c1->buy,$c1->decpoint,'.','') }}
                                            </div>
                                        </td>
                                        <td class="bc3 three-d-text digital" style="color:red;text-align:center;padding:0px;">
                                            <div class="relativeamt" style="">
