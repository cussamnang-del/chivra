...
<head>
    ...
    <title>Exchange Rate Display LPK</title>
            ...
            <div class="col-lg-12 col-sm-12 col-md-12">
                <div class="container-fluid" style="width:1200px;padding:10px;">
                    <div class="card" style="">
                            <table class="table" style="margin:0px;@if(config('helper.transfer_option')=='lpk') background-color:#0b972b; @else background-color:white; @endif ">
                                <tr style="background-color:black;">
                                    <td style="width:33.33%;border-style:none;text-align:left;@if(config('helper.transfer_option')=='lpk') background-color:#0b972b; @else background-color:white; @endif ">
                                        ...
                                        <span class="three-d-text moul-regular" style="position: relative;top:-70px;left:80px;color:goldenrod;font-size:36px;"> {{$company->name}}</span>
                                    </td>
                                    <td style="text-align:center;border-style:none;color:rgb(19, 202, 235);@if(config('helper.transfer_option')=='lpk') background-color:#0b972b; @else background-color:white; @endif ">
                                        <div class="mainshortcut">

                                            <div class="three-d-text moul-regular" style="position: relative;top:-10px;color:gold;font-size:36px;">
                                                អត្រាប្តូរប្រាក់
                                            </div>
                                    ...
                                    <td style="width:33.33%;border-style:none;font-family:Arial, Helvetica, sans-serif;font-size:22px;font-weight:bold;text-align:right;padding-right:20px;@if(config('helper.transfer_option')=='lpk') background-color:#0b972b; @else background-color:white; @endif ">

                                        <div class="mainshortcut">
                                            <div class="three-d-text" style="font-family:Arial, Helvetica, sans-serif;font-size:22px;font-weight:bold;margin-top:0px;position: relative;top:0px;color:silver">
                                ...
                                <table class="table table-bordered"  style="width:100%;margin-top:-10px;">
                                    <tbody>
                                        ...
                                        <tr style="background-color:blue;">
                                            ...
                                            <td class="" style="text-align:center;padding:10px;">
                                                <div class="mainshortcut">
                                                    ...
                                                    <div class="three-d-text moul-regular" style="color:white;font-size:52px;">
                                                        រូបិយប័ណ្ណ
                                                    </div>
                                        ...
                                        @foreach ($cur1 as $c1)
                                            ...
                                            <tr class="{{$cbk}}">
                                                ...
                                                @if($c1->ispandp==1)
                                                    <td class="bc4 three-d-text digital" style="color:blue;text-align:center;">
                                                        <div class="relativeamt" style="padding-right:20px;font-size:100px;">
                                                            {{ number_format($c1->buy,$c1->decpoint,'.','') }}
                                                        </div>
                                                    </td>
                                                    <td class="bc3 three-d-text digital" style="color:red;text-align:center;">
                                                        <div class="relativeamt" style="padding-right:20px;font-size:100px;">
                                 ...
                                 <table class="table" style="margin-top:-10px;">
                                    <tr style="background-color:#094853;">
                                        <td class="moul-regular" style="font-size:42px;padding-top:10px;padding-left:5px;border-style:none;line-height:1.5">
                                            ទំនាក់ទំនង៖
                                            <span style="font-family:Arial, Helvetica, sans-serif;font-size:42px;font-weight:bold;line-height:1.5">{{ $company->tel }}</span> <br>
