          ...
          <div class="modal-body">
              <form id="frmcurrency" class="row g-3" method="post" enctype="multipart/form-data">
                      ...
                      <div class="row mt-1">
                        <table>
                            <tr>
                                <td>
                                    <div class="form-check-danger form-check form-switch">
                                        <input class="form-check-input" style="margin-top:5px;" type="checkbox" id="ismaincur" name="ismaincur">
                                        <label class="form-check-label" for="ismaincur">រូបិយគោល</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check-danger form-check form-switch">
                                        <input class="form-check-input" style="margin-top:5px;" type="checkbox" name="isfn" id="isfn">
                                        <label class="form-check-label" for="isfn">រូបិយបរទេស</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check-danger form-check form-switch">
                                        <input class="form-check-input" style="margin-top:5px;" type="checkbox" id="isactive" name="isactive" checked="">
                            ...
                            <tr>
                                <td>
                                    <div class="form-check-danger form-check form-switch">
                                        <input class="form-check-input" style="margin-top:5px;" type="checkbox" id="isgold" name="isgold">
                                        <label class="form-check-label" for="isgold">Gold</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check-danger form-check form-switch">
                                        <input class="form-check-input" style="margin-top:5px;" type="checkbox" id="dostock" name="dostock">
                                        <label class="form-check-label" for="dostock">do stock</label>
                                    </div>
                                </td>
                            </tr>
                        </table>
                        ...
                        <div>
                            <table>
                                <tr>
                                    <td>
                                        <div class="form-check">
                                            <input class="form-check-input" style="margin-top:7px;" type="radio" name="ck_user_cur" id="ck_allow_user" value="1" checked>
                                            <label class="form-check-label kh16" for="ck_allow_user">ផ្តល់អោយបុគ្គលិក</label>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-check">
                                            <input class="form-check-input" style="margin-top:7px;" type="radio" name="ck_user_cur" id="ck_notallow_user" value="0">
                                            <label class="form-check-label kh16" for="ck_notallow_user">មិនផ្តល់អោយបុគ្គលិក</label>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                ...
                <div class="row" style="">
                    ...
                    <div class="col-lg-4">
                        <label for="company" style="margin-bottom:10px;">កក់ទិញលក់ហាងឆេងមាស(USD)</label>
                        <input type="text" class="form-control" id="buysale_deposit" name="buysale_deposit">
                    </div>
