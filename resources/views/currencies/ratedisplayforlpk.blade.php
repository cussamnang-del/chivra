    ...
    <center>
        <div class="row" style="">
            ...
            <div class="col-lg-12 col-sm-12 col-md-12">
                <div class="container-fluid" style="width:1200px;padding:10px;">
                    <div class="card" style="">
                            <table class="table" style="margin:0px;background-color:#0b972b;">
                                <tr style="background-color:black;">
                                    ...
                                    <td style="width:33.33%;border-style:none;font-family:Arial, Helvetica, sans-serif;font-size:22px;font-weight:bold;text-align:right;padding-right:20px;background-color:#0b972b">
            ...
            <div class="col-lg-12 col-sm-12 col-md-12">
                <div class="container-fluid" style="width:1200px;padding:10px;">
                    <div class="card" style="">
                            <table class="table" style="margin:0px;background-color:green;">
                                <tr style="background-color:black;">
                                    <td style="width:33.33%;border-style:none;text-align:left;background-color:green">
                                        <div class="mainshortcut">
                                            <div class="imgflag">
                                                <div class="circular--logo2">
                                    ...
                                    <td style="text-align:center;border-style:none;color:rgb(19, 202, 235);background-color:green">
                                        <div class="mainshortcut">
                                    ...
                                    <td style="width:33.33%;border-style:none;font-family:Arial, Helvetica, sans-serif;font-size:22px;font-weight:bold;text-align:right;padding-right:20px;background-color:green">
                                ...
                                <table class="table table-bordered"  style="width:100%;margin-top:-10px;">
                                    <tbody>
                                        ...
                                        <tr style="border:1px solid grey;background-color:#73c6f7">
                                            ...
                                            <td class="bc3 three-d-text digital" style="color:blue;text-align:center;">
                                                <div class="relativeamt" style="padding-right:20px;font-size:100px;">
                                                    {{ phpformatnumber($thai_khr->buy??0) }}
                                                </div>
                                            </td>
                                            <td class="bc4 three-d-text digital" style="color:red;text-align:center;">
                                                <div class="relativeamt" style="padding-right:20px;font-size:100px;">
