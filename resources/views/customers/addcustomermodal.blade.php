                                        ...
                                        <td style="border-style:none;" colspan=3>
                                            <table>
                                                <tr>
                                                    ...
                                                    <td style="border-style:none;">
                                                        <div class="form-check-danger form-check form-switch">
                                                            <input class="form-check-input" type="checkbox" id="auto_closelist" name="auto_closelist">
                                                            <label class="form-check-label kh16-b" for="auto_closelist">Auto Close List</label>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
