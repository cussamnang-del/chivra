        ...
        <div class="table-responsive" style="margin-bottom:10px;">
            <table id="tblk" class="table">
                <tr>
                    ...
                    <td style="">
                        <button id="btndelalldata" class="btn-3d btn-3d-danger kh14-b" style="height:25px;">លុបទិន្ន័យគ្រប់បុគ្គលិក</button>
                    </td>
                </tr>
            </table>
        </div>
...
@section('script')
    ...
    function movePreview(event) {
        ...
        // first show temporarily to get size
        ...
        // If goes out right side
        if (x + pw > ww) {
            x = event.clientX - pw - offset;
        }

        // If goes out bottom side
        if (y + ph > wh) {
