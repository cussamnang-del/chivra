            ...
            <table>
                <tr>
                    ...
                    <td style="">
                        ...
                        <button id="btnkatkong" class="mybtn kh14-b" style="height:25px;">ទូទាត់សរុប</button>

                    </td>
                    <td style="padding-left:5px;">
                        <input type="text" class="kh16" style="height:25px;" id="myInput" onkeyup="searchtblexchangelist()" placeholder="Search name or phone ..." title="input customer phone number">
                    </td>
                </tr>
            </table>
        </div>
                        ...
                        <table id="tblexchangelist" class="table table-bordered table-hover tblexchangelist kh14-b" style="table-layout: fixed;">
                            ...
                            <tbody id="bodyexchangelist">
                                ...
                                <tr style="background-color:aqua;border:3px solid green;">
                                    <td colspan=7 class="kh16-b" style="text-align:center;background-color:yellow;">សរុប</td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan=2 class="kh16-b" style="">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control canenter kh16-b" id="total_exid" name="total_exid" readonly>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.9.0/js/bootstrap-datepicker.min.js" crossorigin="anonymous"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            document.getElementById('btnkatkong').addEventListener('click', function () {
                ...
                document.querySelectorAll('.cknum:checked').forEach(function (ck) {
                    ...
                    let ex_group=tds[19].innerText.trim();
                    let ex_id = ex_group.split('-')[1];
                    selectedRows.push({
                        client, phone, product, gold, amount, sumamount, deposit, balance,ex_group,ex_id
                    });
                    ...
                    total_ex_id = (total_ex_id === '') ? ex_id : total_ex_id + '-' + ex_id;
                ...
                $('#total_exid').val(total_ex_id);
                $('#txtdebt2').val(formatNumber(total_balance));
                $('#txtdeposit2').val(formatNumber(Math.abs(total_balance)));
                $('#txtbalance2').val(0);
                $('#txtdeposit3').val(formatNumber(Math.abs(total_balance)));
                // show modal
            ...
            $(document).on('click','#btnsavedeposit2,#btnsavedepositprint2',function(e){
                ...
                formdata.append("bank_amount",bank_amount);
                formdata.append("cash_amount",cash_amount);
                formdata.append("paidform",'goldreport');
        ...
        function searchtblexchangelist1() {
        ...
        function searchtblexchangelist() {
            ...
            let table = document.getElementById("tblexchangelist");
            let tr = table.getElementsByTagName("tr");

            let no = 1; // reset No

            for (let i = 0; i < tr.length; i++) {
                let td2 = tr[i].getElementsByTagName("td")[2]; // column 2
                let td3 = tr[i].getElementsByTagName("td")[3]; // column 3

                if (td2 || td3) {
                    let text2 = td2 ? td2.textContent.toUpperCase() : "";
                    let text3 = td3 ? td3.textContent.toUpperCase() : "";

                    if (text2.includes(filter) || text3.includes(filter)) {
                        tr[i].style.display = "";

                        // reset column No
                        let noSpan = tr[i].querySelector(".row-no");
                        if (noSpan) {
