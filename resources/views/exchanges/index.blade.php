                    ...
                    <div class="card-body" style="padding:0px 25px 0px 25px;">
                        ...
                        <div class="table-responsive" style="margin-top:5px;overflow-y:hidden;">
                            <table class="table table-bordered">
                                ...
                                <tr style="">
                                    <td class="kh16-b" style="width:40px;padding-top:10px;">
                                        ថ្ងៃទី
                                    </td>
                                    <td style="width:110px;">
                                        <input type="text" name="invdate" id="invdate" class="form-control kh16-b" style="padding:2px;width:110px;background-color:inherit;" readonly>
                                    </td>

                                    <td style="padding:0px 0px 0px 20px;text-align:center;">
                                        <div style="">
                                            <button class="buttonstyle1" id="curcur" style="">CUR1-CUR2</button>
                                        </div>
                                    </td>
                                    ...
                                    <div class="table-responsive">
                                        <table id="tblgolddeposit" class="table kh16-b">
                                            ...
                                            <tr>
                                                <td style="width:100px;">
                                                    កក់ចំនួន
                                                    <select class="kh16-b" name="type_deposit" id="type_deposit" style="background-color:yllow;">
                                                        <option value="-1">គេកក់យើង(-1)</option>
                                                        <option value="1">យើងកក់គេ(+1)</option>
                ...
                <table>
                    <tr>
                        <td style="">
                            ...
                            <button id="btnrefreshrate" class="buttonstyle kh14-b" style="height:25px;">KH Rate</button>
                            <button id="btnrefreshratefn" class="buttonstyle kh14-b" style="height:25px;">FN Rate</button>
                            <button id="btnrefreshrategold" class="buttonstyle kh14-b" style="height:25px;">GL Rate</button>
                        </td>
                        <td style="padding:0px;border-style:none;">
