    ...
    <div id="invoice-pos">
        <div class="row" style="margin-top:0px;">
            ...
            <div style="display:flex; align-items:center; justify-content:center; width:100%; padding:0;">
                ...
                <img src="{{ config('helper.asset_path') . '/logo/' . $logo->logo }}"
                            ...
                            @if($bp->trancode==1)
                                ...
                                @if($bp->rectel)
                                    <tr style="">
                                        ...
                                        <td class="kh12-b" style="text-align:right;border:2px dotted black;font-size:16px;padding:0px 3px;">{{ trim(chunk_split($bp->rectel, 3, ' ')) }}</td>
                                    </tr>
                                @endif
                                @if($bp->recname)
                                    <tr style="">
                                        <td class="kh12-b" style="border-style:none;">ឈ្មោះអ្នកទទួល</td>
                                        <td class="kh12-b" style="text-align:right;border-style:none;font-size:16px;">{{ $bp->recname }}</td>
                                    </tr>
                                @endif
                                @if($bp->sendertel)
                                    <tr style="">
