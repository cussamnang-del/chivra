                                ...
                                <div class="form-group form-group-login">
                                    <table style="margin:0 auto;">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <textarea class="form-control kh16" name="timework" id="timework" cols="30" rows="3" placeholder="TimeWork"></textarea>
                                            </td>
                                        </tr>
                                         <tr>
                                        <td>
                                                <textarea class="form-control kh16" name="goldnote" id="goldnote" cols="30" rows="5" placeholder="Gold Note"></textarea>
                                            </td>
                                        </tr>
                                      </tbody>
                                    </table>
		...
		$(document).ready(function(){
			...
			$(document).on('click','.row-edit',function(e){
				...
				$.get(url,{id:id},function(data){
                    ...
                    $('#tel2').val(data.tel2);
                    $('#tel3').val(data.tel3);
                    $('#timework').val(data.timework);
                    $('#goldnote').val(data.inv_gold_note);
