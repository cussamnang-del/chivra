...
Route::get('/goldrate', [App\Http\Controllers\CurrencyController::class,'ratedisplayforgold'])->name('currency.goldrate');
...
Route::get('/ratedisplayforcustomer/{isfn}/{isgold}', [App\Http\Controllers\CurrencyController::class,'ratedisplayforcustomer'])->name('currency.ratedisplayforcustomer');
...
Route::get('/getrate_tv', [App\Http\Controllers\CurrencyController::class,'getrate_tv'])->name('currency.getrate_tv');
...
Route::group(['middleware'=>['auth']],function(){
    ...
    Route::get('/goldchartdata', [App\Http\Controllers\CurrencyController::class,'goldChartData'])->name('currency.goldchartdata');
...
Route::group(['middleware'=>['auth']],function(){
    Route::get('/exchangegoldapp-report', [App\Http\Controllers\ExchangeGoldController::class,'report'])->name('exchangegoldapp.report');
    Route::get('/exchangegoldapp-search', [App\Http\Controllers\ExchangeGoldController::class,'search'])->name('exchangegoldapp.search');
    Route::get('/exchangegoldapp-search1', [App\Http\Controllers\ExchangeGoldController::class,'search1'])->name('exchangegoldapp.search1');
    Route::get('/exchangegoldapp-setgoldrate', [App\Http\Controllers\ExchangeGoldController::class,'setgoldrate'])->name('exchangegoldapp.setgoldrate');
    Route::get('/exchangegoldapp-buysalegold', [App\Http\Controllers\ExchangeGoldController::class,'buysalegold'])->name('exchangegoldapp.buysalegold');
     Route::get('/getexchangegoldlist', [App\Http\Controllers\ExchangeGoldController::class,'getexchangegoldlist'])->name('getexchangegoldlist');
    ...
    Route::post('/savedepositgold2', [App\Http\Controllers\ExchangeController::class,'savedepositgold2'])->name('exchange.savedepositgold2');
    ...
    Route::get('/exchangegoldlist', [App\Http\Controllers\ExchangeController::class,'exchangegoldlist'])->name('exchangegoldlist');
    ...
    Route::get('/deletegoldpayment', [App\Http\Controllers\ExchangeController::class,'deletegoldpayment'])->name('deletegoldpayment');
    ...
    Route::get('/getgoldlist', [App\Http\Controllers\ExchangeController::class,'getgoldlist'])->name('getgoldlist');
    Route::get('/getgoldlistdetail', [App\Http\Controllers\ExchangeController::class,'getgoldlistdetail'])->name('getgoldlistdetail');
    Route::get('/cleargoldlist', [App\Http\Controllers\ExchangeController::class,'cleargoldlist'])->name('cleargoldlist');
    Route::get('/getcleardate', [App\Http\Controllers\ExchangeController::class,'getcleardate'])->name('getcleardate');
    Route::get('/deletecleargoldlist', [App\Http\Controllers\ExchangeController::class,'deletecleargoldlist'])->name('deletecleargoldlist');
...
Route::group(['middleware'=>['auth']],function(){
    ...
    Route::get('/moneytransfer/customertransfer1', [App\Http\Controllers\MoneyTransferController::class,'customertransfer'])->name('moneytransfer.customertransfer1');
    ...
    Route::post('/moneytransfer/justupdateinfo', [App\Http\Controllers\MoneyTransferController::class,'justupdateinfo'])->name('moneytransfer.justupdateinfo');
...
Route::group(['middleware'=>['auth']],function(){
    ...
    Route::get('/realestate/deletecomzero', [App\Http\Controllers\RealEstateController::class,'deletecomzero'])->name('realestate.deletecomzero');
    ...
    Route::get('/realestate/viewallcustomertransaction', [App\Http\Controllers\RealEstateController::class,'viewallcustomertransaction'])->name('realestate.viewallcustomertransaction');
    Route::post('/realestate/updatetransactiondate', [App\Http\Controllers\RealEstateController::class,'updatetransactiondate'])->name('realestate.updatetransactiondate');
    ...
    Route::get('/realestate/getcommissionlistall/print', [App\Http\Controllers\RealEstateController::class,'getcommissionlistall'])->name('realestate.getcommissionlistallprint');
