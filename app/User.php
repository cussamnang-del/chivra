...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    protected $fillable = [
        'name','username','email', 'password','active','role_id','remember_token','verifyToken','customer_connect','connect_customer_id','company_id','remote_password','block_time','attempt'
    ];
    ...
    {
    	return $this->belongsTo('App\Customer','connect_customer_id')->withDefault(['name' =>'']);
    }
